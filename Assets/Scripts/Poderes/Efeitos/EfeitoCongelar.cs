...
public class EfeitoCongelar : Efeito
{
    ...
    async void Congelar(Ser_Vivo _vitima, Ser_Vivo _atacante)
    {
        ...
        _vitima.GetComponent<Animator>().speed = 1 - (Utilidades.LimitadorNumero(0, 1, (_atacante._poderGelo._status._utilidade1 - _vitima._poderGelo._status._negacaoUtilidade1) / 100));
        _vitima._mao.GetComponent<Animator>().speed = 1 - (Utilidades.LimitadorNumero(0, 1, (_atacante._poderGelo._status._utilidade1 - _vitima._poderGelo._status._negacaoUtilidade1) / 100));
        if (_vitima.gameObject.GetComponent<NavMeshAgent>() != null)
        {
            ...
            _vitima.gameObject.GetComponent<NavMeshAgent>().speed = _velocidadePadrao * (1 - (Utilidades.LimitadorNumero(0, 1, (_atacante._poderGelo._status._utilidade1 - _vitima._poderGelo._status._negacaoUtilidade1) / 100)));
        }
        _vitima._mao.GetComponent<Mao>()._latenciaMira = _latenciaMira * (1 - (Utilidades.LimitadorNumero(0, 1, (_atacante._poderGelo._status._utilidade1 - _vitima._poderGelo._status._negacaoUtilidade1) / 100)));
    ...
    {
        _vitima._poderGelo._status._acumuloAtual += _atacante._poderGelo._status._infligirAcumulo;
        if(_vitima._poderGelo._status._acumuloAtual >= _vitima._poderGelo._status._acumuloMax)
        {
    ...
    void InstanciarParticulaEfeito(float _duracao, Ser_Vivo _vitima, Ser_Vivo _atacante)
    {
        ...
        _emissao.rateOverTime = new ParticleSystem.MinMaxCurve(Utilidades.LimitadorNumero(0, _emissao.rateOverTime.constant, (_atacante._poderGelo._status._utilidade1 - _vitima._poderGelo._status._negacaoUtilidade1) / 50 * _emissao.rateOverTime.constant));
